...
class BradsBoilerplate {
  ...
  function renderCallbackBasic($attributes) {
    return '<div class="boilerplate-frontend">Hello, the sky is ' . $attributes['skyColor'] . ' and the grass is ' . $attributes['grassColor'] . 'and the select is' .$attributes['select'] . '</div>';
  }
}
